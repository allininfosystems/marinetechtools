define(['jquery','M2ePro/Grid','Magento_Ui/js/modal/modal'],function(jquery,grid,modal){window.ControlPanelDatabaseGrid=Class.create(Grid,{mergeModeCookieKey:null,setMergeModeCookieKey:function(key)
...
{var result=false;$$('#controlPanel_tabs_database_table_cells_popup .input_switcher').each(function(el){if(el.checked){result=true;return true;}});return result;}});});