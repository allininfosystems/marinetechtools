define(['M2ePro/Plugin/Messages',],function(MessageObj){window.WizardInstallationEbay=Class.create(Common,{continueStep:function()
...
{WizardObj.setStep(WizardObj.getNextStep(),function(){WizardObj.complete();});}});});