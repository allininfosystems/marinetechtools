define(['M2ePro/Amazon/Template/Description/Category/Specific/Grid/RowRenderer'],function(){window.AmazonTemplateDescriptionCategorySpecificGridRowAttributeRenderer=Class.create(AmazonTemplateDescriptionCategorySpecificGridRowRenderer,{attribute:null,attributeIndex:null,process:function()
{if(!this.load()){return'';}
...
var grid=$$('table[id="'+this.getParentIndexedXpath()+'_grid"] table.border tbody').first();return grid.appendChild(new Element('tr',{id:id,class:this.indexedXPath+'_attributes'}));}});});