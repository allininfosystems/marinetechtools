define(['jquery','M2ePro/Plugin/Storage','M2ePro/Common'],function(jQuery,localStorage){window.BlockNotice=Class.create(Common,{initializedBlocks:[],storageKeys:{prefix:'m2e_bn_',shown:'_was_shown',closed:'_closed',hiddenContent:'_hidden_content',expandedContent:'_expanded_content',},getHashedStorage:function(id)
...
{var index=this.initializedBlocks.indexOf(block);if(index>-1){this.initializedBlocks.splice(index,1);}}});});