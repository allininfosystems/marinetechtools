define([],function(){window.AmazonTemplateDescriptionCategorySpecificDictionary=Class.create();AmazonTemplateDescriptionCategorySpecificDictionary.prototype={TYPE_TEXT:1,TYPE_SELECT:2,TYPE_CONTAINER:3,dictionarySpecifics:{},initialize:function(){},setDictionarySpecifics:function(specifics)
...
{var self=this;var dictionarySpecific;xPathWithIndex=xPathWithIndex.replace(/\/\-\d{1,}\//g,'/').replace(/\-\d*/g,'');$H(self.dictionarySpecifics).each(function(specificData){var specific=specificData.pop();if(specific.xpath==xPathWithIndex){dictionarySpecific=specific;throw $break;}});return dictionarySpecific;}};});