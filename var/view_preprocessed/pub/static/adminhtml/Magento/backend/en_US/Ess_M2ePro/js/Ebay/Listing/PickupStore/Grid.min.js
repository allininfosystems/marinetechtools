define(['jquery','Magento_Ui/js/modal/modal','M2ePro/Plugin/Messages','M2ePro/Listing/View/Grid','M2ePro/Listing/View/Action'],function(jQuery,Modal,MessageObj){window.EbayListingPickupStoreGrid=Class.create(ListingViewGrid,{popup:null,variationPopup:null,logPopup:null,pickupStoreStepProducts:function(listingId,callback)
