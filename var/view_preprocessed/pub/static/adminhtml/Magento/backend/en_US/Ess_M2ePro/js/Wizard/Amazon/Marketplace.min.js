define(['M2ePro/Plugin/Messages','M2ePro/Marketplace'],function(MessageObj){window.WizardAmazonMarketplace=Class.create(Marketplace,{proceedAction:function()
...
{var allSelect=$$('select[id*="status_"]');if(allSelect.length){allSelect.each(function(element){element.disabled=true;});}}});});