define(['jquery','mage/apply/main','M2ePro/Common'],function(jQuery,mage){window.EbayPickupStore=Class.create(Common,{autogenerate:false,geocodeObject:{},defaultBusinessHours:{},initialize:function()
