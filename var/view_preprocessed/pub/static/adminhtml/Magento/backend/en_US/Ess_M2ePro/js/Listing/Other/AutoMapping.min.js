define(['M2ePro/Plugin/Messages','M2ePro/Action'],function(MessagesObj){window.ListingOtherAutoMapping=Class.create(Action,{options:{},setOptions:function(options)
...
setTimeout(function(){self.sendPartsOfProducts(parts,totalPartsCount,isFailed);},500);}});}});});