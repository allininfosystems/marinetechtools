define(['Magento_Ui/js/modal/modal','M2ePro/Common','extjs/ext-tree-checkbox','mage/adminhtml/form'],function(modal){window.EbayAccount=Class.create(Common,{initialize:function()
...
attributeEl.value='';if(this.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Account::OTHER_LISTINGS_MAPPING_TITLE_MODE_CUSTOM_ATTRIBUTE')){self.updateHiddenValue(this,attributeEl);}}});});