define(['Magento_Ui/js/modal/modal','M2ePro/Plugin/Messages','M2ePro/Action'],function(modal,MessageObj){window.AmazonListingProductTemplateProductTaxCode=Class.create(Action,{initialize:function($super,gridHandler)
...
clearInterval(intervalId);self.loadGrid();},1000);}});});