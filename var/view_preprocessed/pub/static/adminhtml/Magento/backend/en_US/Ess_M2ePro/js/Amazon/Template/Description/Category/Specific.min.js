define(['jquery','M2ePro/Common'],function(jQuery){window.AmazonTemplateDescriptionCategorySpecific=Class.create(Common,{initialize:function()
...
{return typeof this.themeAttributes[specific.xml_tag]!='undefined'&&this.themeAttributes[specific.xml_tag].length>0;}});});