define(['M2ePro/Common','extjs/ext-tree-checkbox'],function(){window.ListingCategoryTree=Class.create(Common,{initialize:function(){},tree_buildCategory:function(parent,config)
{if(!config){return;}
