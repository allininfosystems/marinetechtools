define(['jquery','Magento_Ui/js/modal/modal','M2ePro/Plugin/Messages','M2ePro/Common'],function(jQuery,modal,MessagesObj){window.ListingOtherMapping=Class.create(Common,{initialize:function(gridHandler,component)
