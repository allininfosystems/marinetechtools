define(['jquery','Magento_Ui/js/modal/modal','M2ePro/Plugin/Messages','M2ePro/Action'],function(jQuery,modal,messageObj){window.EbayListingVariationProductManage=Class.create(Action,{initialize:function($super,gridHandler)
