define(['jquery','Magento_Ui/js/modal/modal','M2ePro/Common'],function(jQuery,modal){window.EbayTemplateShipping=Class.create(Common,{shippingMethods:{},missingAttributes:{},discountProfiles:[],shippingServices:[],shippingLocations:[],counter:{local:0,international:0,total:0},originCountry:null,initialize:function()
...
{if(typeof EbayListingTemplateSwitcherObj=='undefined'){return;}
var container=type=='local'?'shipping_local_table_messages':'shipping_international_table_messages';$(container).innerHTML='';}});});