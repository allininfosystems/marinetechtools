...
this.clearEvents();if(this._checkForVideoExist()){this._checkFullscreen();this._listenForFullscreen();this._checkForVimeo();this._isVideoBase();this._initFotoramaVideo();this._attachFotoramaEvents();}},clearEvents:function(){this.fotoramaItem.off('fotorama:show '+'fotorama:showend '+'fotorama:fullscreenenter '+'fotorama:fullscreenexit');},_setOptions:function(options){if(options.videoData&&options.videoData.length){this.options.videoData=options.videoData;}
