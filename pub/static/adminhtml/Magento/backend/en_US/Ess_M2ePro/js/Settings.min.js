...
if(result.success){self.messageObj.addSuccessMessage(M2ePro.translator.translate('Settings successfully saved'));}else{self.messageObj.addErrorMessage(M2ePro.translator.translate('Error'));}}});}});});