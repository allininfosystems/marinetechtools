define(['M2ePro/Plugin/Messages','M2ePro/Action','M2ePro/Plugin/ProgressBar','M2ePro/Plugin/AreaWrapper'],function(MagentoMessageObj){window.ListingViewAction=Class.create(Action,{initialize:function($super,gridHandler)
...
self.startActions(self.options.text.stop_translate_selected_items_message,self.options.url.get('runStopTranslateProducts'),selectedProductsParts);},cancel:function(){return false;}}});}});});