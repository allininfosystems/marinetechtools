define(function(){window.MigrationFromMagento1=Class.create(Common,{continueStep:function()
...
{var title=component+' '+$('marketplace_'+marketplaceId).innerHTML;MarketplaceSynchProgressObj.runTask(title,M2ePro.url.get('wizard_migrationFromMagento1/runSynchNow')+'marketplace_id/'+marketplaceId,'','MigrationFromMagento1Obj.synchronizationStep()');}});});