define(['jquery','M2ePro/Ebay/Listing/View/Grid','M2ePro/Listing/Moving','Magento_Ui/js/modal/modal'],function(jQuery){window.EbayListingViewSettingsGrid=Class.create(EbayListingViewGrid,{initialize:function($super,gridId,listingId)
