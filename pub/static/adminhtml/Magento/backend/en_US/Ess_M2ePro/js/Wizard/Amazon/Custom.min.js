define(function(){window.WizardAmazonCustom=Class.create();WizardAmazonCustom.prototype={initialize:function()
...
{var span=new Element('span',{class:'synchProcess status-process'});span.innerHTML=' (In Progress)';element.appendChild(span);element.addClassName('synchProcess');}};});