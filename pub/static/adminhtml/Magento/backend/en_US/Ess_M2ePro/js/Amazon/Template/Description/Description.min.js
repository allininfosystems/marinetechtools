define(['jquery','underscore','M2ePro/Amazon/Template/Edit'],function(jQuery,_){window.AmazonTemplateDescription=Class.create(AmazonTemplateEdit,{initialize:function()
