define(['Magento_Ui/js/modal/modal','M2ePro/Common','mage/adminhtml/wysiwyg/tiny_mce/setup'],function(){window.EbayTemplateDescription=Class.create(Common,{initialize:function()
