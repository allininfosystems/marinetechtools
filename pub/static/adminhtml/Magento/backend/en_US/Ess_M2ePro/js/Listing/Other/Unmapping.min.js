define(['jquery','M2ePro/Plugin/Messages','M2ePro/Action'],function(jQuery,MessagesObj){window.ListingOtherUnmapping=Class.create(Action,{options:{},setOptions:function(options)
...
this.gridHandler.unselectAllAndReload();}).bind(this)});}});});