...
{jQuery('<div>').confirm({title:message,actions:{always:function(){configData.closeCallback&&configData.closeCallback();},confirm:function(){configData.confirmCallback&&configData.confirmCallback();return true;},buttons:[{text:M2ePro.translator.translate('Cancel')},{text:M2ePro.translator.translate('Confirm'),class:'primary'}]}});}});});