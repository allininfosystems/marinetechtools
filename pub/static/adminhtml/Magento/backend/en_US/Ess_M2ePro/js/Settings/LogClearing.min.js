define(['M2ePro/Common'],function(){window.SettingsLogClearing=Class.create(Common,{initialize:function()
...
{var value=$(log+'_log_mode').value,button=$$('.clear_all_'+log).shift();if(value=='1'){$(log+'_log_days_container').style.display='';button&&button.show();}else{$(log+'_log_days_container').style.display='none';button&&button.hide();}}});});