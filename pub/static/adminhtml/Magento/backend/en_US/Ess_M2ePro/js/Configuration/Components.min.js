define(function(){window.ConfigurationComponents=Class.create(Common,{componentsTitles:[],initialize:function()
...
self.componentsTitles[nick]+'</option>';}});$('view_common_component_default').innerHTML=html;}});});