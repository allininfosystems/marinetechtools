define(['jquery','Magento_Ui/js/modal/modal','M2ePro/Plugin/Messages','M2ePro/Common'],function(jQuery,modal,MessagesObj){window.License=Class.create(Common,{changeLicenseKeyPopup:function()
...
{BlockNoticeObj.removeInitializedBlock('block_notice_configuration_license');new Ajax.Request(M2ePro.url.get('licenseTab'),{method:'get',asynchronous:true,onSuccess:function(transport){var result=transport.responseText;$('configuration_settings_tabs_license_content').innerHTML=result;$('configuration_settings_tabs_license_content').innerHTML.evalScripts();}});}});});