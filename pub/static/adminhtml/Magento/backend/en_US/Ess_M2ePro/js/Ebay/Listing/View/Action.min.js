define(['M2ePro/Listing/View/Action'],function(){window.EbayListingViewAction=Class.create(ListingViewAction,{startActions:function($super,title,url,selectedProductsParts,requestParams)
...
{var selectedProductsParts=this.gridHandler.getSelectedItemsParts(100);if(selectedProductsParts.length==0){return;}
var requestParams={'is_realtime':(this.gridHandler.getSelectedProductsArray().length<=100)};this.startActions(M2ePro.translator.translate('stopping_and_removing_selected_items_message'),M2ePro.url.get('ebay_listing/runStopAndRemoveProducts'),selectedProductsParts,requestParams);}});});