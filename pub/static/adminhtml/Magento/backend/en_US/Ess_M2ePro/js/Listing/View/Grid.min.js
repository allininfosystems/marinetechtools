define(['M2ePro/Grid','M2ePro/Listing/View/Action'],function(){window.ListingViewGrid=Class.create(Grid,{productIdCellIndex:1,productTitleCellIndex:2,initialize:function($super,gridId,listingId)
