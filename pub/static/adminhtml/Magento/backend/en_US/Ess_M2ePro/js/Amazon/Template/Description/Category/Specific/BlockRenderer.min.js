define(['M2ePro/Amazon/Template/Description/Category/Specific/Renderer'],function(){window.AmazonTemplateDescriptionCategorySpecificBlockRenderer=Class.create(AmazonTemplateDescriptionCategorySpecificRenderer,{isRootBlock:false,isFlatBlock:false,withOneBlockOnly:false,parentWithOneBlockOnly:false,childFilteredSpecifics:{all:[],containers:[],rows:[]},process:function()
