define(['jquery','M2ePro/Amazon/Template/Edit'],function(jQuery){window.AmazonTemplateSellingFormat=Class.create(AmazonTemplateEdit,{discountRulesCount:0,initialize:function()
...
{var self=AmazonTemplateSellingFormatObj;target.previous().value='';if(target.value==M2ePro.php.constant('Ess_M2ePro_Model_Template_SellingFormat::PRICE_MODE_ATTRIBUTE')){self.updateHiddenValue(target,target.previous());}}});});