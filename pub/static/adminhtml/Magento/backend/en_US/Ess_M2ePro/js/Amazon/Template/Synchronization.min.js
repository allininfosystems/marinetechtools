define(['M2ePro/Amazon/Template/Edit','Magento_Ui/js/modal/confirm'],function(){window.AmazonTemplateSynchronization=Class.create(AmazonTemplateEdit,{initialize:function()
...
{$('revise_update_price_max_allowed_deviation_mode').selectedIndex=0;$('revise_update_price_max_allowed_deviation_mode').simulate('change');}});});