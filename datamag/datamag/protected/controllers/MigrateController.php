    ...
    public function actionStep6()
    {
        ...
        if ($result['allowed']){
            ...
            if (1){
                ...
                $selected_group_ids = array(1,2,3); //Yii::app()->request->getPost('customer_group_ids', array());
                ...
                if ($selected_group_ids){
                    foreach ($selected_group_ids as $group_id){
                        ...
                        if (1){
                            ...
                            $Criteria->condition = "group_id = $group_id AND entity_id > 3452";
                            //$Products = Product::model()->findAll($Criteria);

                            //$customers = Mage1CustomerEntity::model()->findAll(array("group_id = {$group_id}", "entity_id" > 3838));
                            $customers = Mage1CustomerEntity::model()->findAll($Criteria);

                           //echo "<pre>"; print_r($customers); die("sssss");

                            if ($customers){ 
                                foreach ($customers as $customer){
                                    $customer2 = Mage2CustomerEntity::model()->findByPk($customer->entity_id);
                                  //echo "<pre>"; print_r($customer2);  die("aaaa");
                                    if (!$customer2){
                                         ...
                                         //customer_address_entity
                                            ...
                                            if ($address_entities){
                                                foreach($address_entities as $address_entity){
                                                    ...
                                                    unset($address_entity2->entity_id);
            ...
            if (1){
                ...
                if ($selected_objects){
                    ...
                    if (1){
                        ...
                        //sales_order
                        $condition = "( store_id IN (0,1) OR store_id IS NULL ) AND entity_id > 4625";
                        if (0){
                        ...
                        if ($sales_orders){
                            foreach ($sales_orders as $sales_order){
                                ...
                                $sales_order2->entity_id = $sales_order2->entity_id + 30;
                                ...
                                if ($sales_order2->save()){
                                    ...
                                    if ($models){
                                        foreach ($models as $model){
                                            ...
                                            $model2->entity_id = $model2->entity_id;
                                            $model2->save();
                                        }
                                    }
                                    //sales_order_grid
                        ...
                        $condition = "store_id IN (0,1) OR store_id is NULL";
                    ...
                    if (in_array('bestseller', $selected_objects) && !in_array('bestseller', $migrated_sales_object_ids)){
                        if ($migrated_store_ids && $migrated_product_ids){
                            $condition = "store_id IN (0,1) AND product_id IN ({$str_product_ids})";
